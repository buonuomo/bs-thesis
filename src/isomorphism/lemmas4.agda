...
-- NoTE: the termination issue ss probably have to do with is a bug with with abstractions
-- introduces in 2.6.1 for some more details See
-- https://stackoverflow.com/questions/62722346/failing-termination-check-with-a-with-abstraction
